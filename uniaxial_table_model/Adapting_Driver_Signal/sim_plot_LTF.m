...
% plot(tgt_time_vector_LAquilaReducedScale , scaleFactor*tgtDispT_LAquilaReducedScale,'LineWidth' , 2,'DisplayName', 'Target')
% plot(DRV_time_vector_LAquilaReducedScale_34 , DRVDispT_LAquilaReducedScale_34, 'LineWidth' , 2,'DisplayName', 'Driver')
