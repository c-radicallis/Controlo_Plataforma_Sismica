clear; clc; close all; addpath 'C:\Users\afons\OneDrive - Universidade de Lisboa\Controlo de Plataforma Sismica\uniaxial_table_model'
%%
...
sys=G_Fp_isv*G_xT_Fp
sys_minreal=zpk(minreal(sys))
...
G = zeros(nx);         % Process noise matrix 
H = zeros(ny, nx);   % Noise feedthrough
% x = A*x + B*u + G*w
% y = C*x + D*u + H*w + v
