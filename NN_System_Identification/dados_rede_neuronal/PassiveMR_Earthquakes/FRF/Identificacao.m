...
subplot(312),plot(data.FRF.f,angle(data.FRF.AgS2Xg)*180/pi),xlim(frange),ylim([-180 180]),ylabel('Phase (º)')
...
subplot(312),plot(data.FRF.f,angle(data.FRF.XigS2Xg)*180/pi,data.FRF.f,angle(data.FRF.XigAg)*180/pi),xlim(frange),ylim([-180 180]),ylabel('Phase (º)')
set(gca,'YTick',-180:90:180),set(gca,'YTickLabel',{'-180','-90','0','90','180'})
...
subplot(312),plot(data.FRF.f,angle(data.FRF.XsiS2Xg)*180/pi,data.FRF.f,angle(data.FRF.XsiAg)*180/pi),xlim(frange),ylim([-180 180]),ylabel('Phase (º)')
set(gca,'YTick',-180:90:180),set(gca,'YTickLabel',{'-180','-90','0','90','180'})
...
subplot(312),plot(data.FRF.f,angle(data.FRF.XiXg)*180/pi,data.FRF.f,angle(data.FRF.AiAg)*180/pi),xlim(frange),ylim([-180 180]),ylabel('Phase (º)')
set(gca,'YTick',-180:90:180),set(gca,'YTickLabel',{'-180','-90','0','90','180'})
...
subplot(312),plot(data.FRF.f,angle(data.FRF.XsXg)*180/pi,data.FRF.f,angle(data.FRF.AsAg)*180/pi),xlim(frange),ylim([-180 180]),ylabel('Phase (º)')
set(gca,'YTick',-180:90:180),set(gca,'YTickLabel',{'-180','-90','0','90','180'})
