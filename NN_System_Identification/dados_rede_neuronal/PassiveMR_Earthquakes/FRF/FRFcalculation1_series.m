...
quake='A2'; %Acao: 'A1';'A2';%A1&2
Vin='1';  %tensao eletrica:0-5
...
subplot(311),
loglog(fo,abs(hXgrXg)),xlim(frange),ylabel('Mag'),ylim([0.1 10]),title('Xg/X_{gr}')
...
figure('Position',[300 10 600 700]),
subplot(311),
semilogy(fo,abs(hXgrXg)),xlim(frange),ylabel('Mag'),ylim([0.1 10]),title('Xg/X_{gr}')
...
%file=strcat('TDOF_SigOutFD_A',num2str(serie(i)),'_all_Gdif');
